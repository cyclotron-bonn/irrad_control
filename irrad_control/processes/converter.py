...
class IrradConverter(DAQProcess):
    ...
    def _interpret_scan_data(self, server, data, meta):
        ...
        if data['status'] == 'scan_init':
            ...
            self.data_arrays[server]['irrad']['dut_rect_start_x'] = data['dut_rect_upper'][0]
            self.data_arrays[server]['irrad']['dut_rect_start_y'] = data['dut_rect_upper'][1]
            self.data_arrays[server]['irrad']['dut_rect_stop_x'] = data['dut_rect_lower'][0]
            self.data_arrays[server]['irrad']['dut_rect_stop_y'] = data['dut_rect_lower'][1]
